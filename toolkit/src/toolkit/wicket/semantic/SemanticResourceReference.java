...
public class SemanticResourceReference extends JavaScriptResourceReference {
    ...
    public Iterable<? extends HeaderItem> getDependencies() {
        ...
        CssReferenceHeaderItem overrides = CssHeaderItem.forReference(new CssResourceReference(SemanticResourceReference.class, "resources/semantic-overrides.css"));
        ...
        return Arrays.asList(jquery, style, overrides, inmethodStyle, easyGridOverrides, select2Style, select2Overrides);
    }
