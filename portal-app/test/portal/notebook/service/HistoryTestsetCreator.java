...
public class HistoryTestsetCreator extends AbstractTestCase {
    ...
    public void createTestset() throws Exception {
        ...
        NotebookEditableDTO savepoint1DTO  = notebookVariableClient.createSavepoint(notebookDTO.getId(), editable1DTO.getId() );
        ...
        NotebookEditableDTO savepoint2DTO  = notebookVariableClient.createSavepoint(notebookDTO.getId(), editable2DTO.getId() );
