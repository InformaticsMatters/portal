...
var execute = function(selection, config, data) {
    ...
    var colorScale = config.colorScale ? config.colorScale :
        ...
        rowIndexes = d3.range(rows.length), // row indexes allow the correct row to be loacted after sorting
  ...
  var heatMap = svg.append("g").attr("class","g3")
        ...
        .on("mouseover", function(d){
               ...
               d3.select("#tooltip")
                 ...
                 .select("#value")
                 .html("labels: " + rows[d.row].name + ", " + cols[d.col].name + "<br>value: "+d.value+"<br>row,col: "+d.col+", "+d.row+"<br>cell x,y: "+this.x.baseVal.value+", "+this.y.baseVal.value);
               //Show the tooltip
