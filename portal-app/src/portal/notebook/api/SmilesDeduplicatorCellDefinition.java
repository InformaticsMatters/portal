...
public class SmilesDeduplicatorCellDefinition extends CellDefinition {
    ...
    public SmilesDeduplicatorCellDefinition() {
        ...
        getOptionDefinitionList().add(new OptionDescriptor<>(String.class, StepDefinitionConstants.SmilesDeduplicator.OPTION_CANONICAL_SMILES_FIELD, "Canonical smiles field", "Field with canonical smiles that identifies identical structures")
                .withMinValues(1));
