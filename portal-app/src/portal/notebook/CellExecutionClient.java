...
public class CellExecutionClient extends AbstractServiceClient implements Serializable {
    ...
    public NotebookDefinitionDTO retrieveNotebookDefinition(Long notebookId) {
        MultivaluedMap<String, String> queryParams = new MultivaluedMapImpl();
        queryParams.add("notebookId", notebookId.toString());
        return newResourceBuilder("/retrieveNotebookDefinition", queryParams).get(NotebookDefinitionDTO.class);
